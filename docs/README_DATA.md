...
- **Fuente:** dataset sintético generado a partir de reglas de negocio de la Dirección de Prestaciones Médicas (domicilio en TDF, ausencia de cobertura, documentación completa, disponibilidad en red pública).
